...
def synthesize_text(text, models, show_graphs=True, max_duration=20, 
                   stop_threshold=0.5, superres_strength=4, 
    ...
    pronunciation_dict = models['pronunciation_dict']

    # Apply configuration
    model.decoder.max_decoder_steps = max_duration * 80
    model.decoder.gate_threshold = stop_threshold
    
    # Apply pronunciation dictionary if enabled
    if use_pronunciation_dict:
        text = ARPA(text, pronunciation_dict)
